...
##                                                                                                                     ##
##                                                                                                                     ##
##                                        Configuração do tutoric + keycloak                                           ##
##                                                                                                                     ##
## https://ipbrick.tutoric.ucoip.pt                                                   IPBRICK by EXPANDINDUSTRIA 2025  ##
#########################################################################################################################


** É necessário que o keycloak tenha certificados válidos. Caso o servidor não tenha certificados válidos, é necessário instala-los manualmente:	
    1. Instale o certbot e o openssl
        '''
        sudo apt update
    ...
    <VirtualHost *:443>
        ...
        SSLEngine on
        SSLCertificateFile    /etc/letsencrypt/live/keycloak.a2o.ucoip.pt/fullchain.pem     # Adicione o caminho para as certificados gerados
        SSLCertificateKeyFile /etc/letsencrypt/live/keycloak.a2o.ucoip.pt/privkey.pem       # Adicione o caminho para as certificados gerados
        HostNameLookups off
        IdentityCheck off
        ProxyRequests off
        SSLProxyEngine On
...
** Gere chaves .pem que serão cadastradas nas configurações do REALM:
    '''
